...
const GetBells = () => {
  ...
  const handleGetBellsById = () => {
    // Code For Getting Bells By ID
    if (validation.value.trim() !== "") {
      fetch(`${authCtx.baseURL}/api/bells/${validation.value}`, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${authCtx.token}`,
        },
                ...
                >
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell>Bell Of Day</TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
                    {response
                      ...
                      .map((row) => (
                        <TableRow key={row.id} hover>
                          ...
                          <TableCell align="left">{row.bellOfDay}</TableCell>
                        </TableRow>
                      ))}
                  </TableBody>
                </Table>
