...
const GetCourses = () => {
  ...
  const handleGetCoursesById = () => {
    // Code For Getting Courses By ID
    if (validation.value.trim() !== "") {
      fetch(`${authCtx.baseURL}/api/courses/${validation.value}`, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${authCtx.token}`,
        },
                ...
                >
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell>Units Count</TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
                    {response
                      ...
                      .map((row) => (
                        <TableRow key={row.id} hover>
                          ...
                          <TableCell align="left">{row.unitsCount}</TableCell>
                        </TableRow>
                      ))}
                  </TableBody>
                </Table>
